...
var ArticlesActions = function () {
  function ArticlesActions() {
    _classCallCheck(this, ArticlesActions);

    this.generateActions('getArticlesSuccess', 'getArticlesFail');
  }

  _createClass(ArticlesActions, [{
    key: 'getArticles',
...
exports.default = _alt2.default.createActions(ArticlesActions);
...
},{"./Articles":4,"react":"react"}],4:[function(require,module,exports){
'use strict';
...
var _ArticlesStore = require('../stores/ArticlesStore');

var _ArticlesStore2 = _interopRequireDefault(_ArticlesStore);

var _ArticlesActions = require('../actions/ArticlesActions');

var _ArticlesActions2 = _interopRequireDefault(_ArticlesActions);
...
var Articles = function (_React$Component) {
  ...
  function Articles(props) {
    ...
    var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(Articles).call(this, props));

    _this.state = _ArticlesStore2.default.getState();
  ...
  _createClass(Articles, [{
    ...
    value: function componentDidMount() {
      _ArticlesStore2.default.listen(this.onChange);
      _ArticlesActions2.default.getArticles();
    }
  }, {
    key: 'componentWillUnmount',
    value: function componentWillUnmount() {
      _ArticlesStore2.default.unlisten(this.onChange);
    }
  }, {
    key: 'onChange',
    ...
    value: function render() {
      ...
      var sideArticles = this.state.articles.filter(function (a) {
        return !a.isMain;
      }).map(function (article) {
        return _react2.default.createElement(
          'article',
          { className: 'news_intro' },
          _react2.default.createElement(
            'a',
            { href: '#' },
            _react2.default.createElement('img', { className: 'pic', src: article.image, width: '120', height: '80', alt: article.title })
          ),
          _react2.default.createElement(
            'header',
            null,
            ...
            _react2.default.createElement('time', { className: 'timeago' }),
            _react2.default.createElement(
              'span',
              { className: 'by_author' },
              article.author
          ...
          _react2.default.createElement('a', { href: '#', title: 'pro�itaj vi�e', className: 'more_arrows sport_8_arrow' })
        );
      });

      var mainArticle = this.state.articles.filter(function (a) {
        return a.isMain;
      }).map(function (article) {
        return _react2.default.createElement(
          'article',
          { className: 'position_one', id: 'rpc_position_one' },
          _react2.default.createElement(
            'a',
            { href: '#' },
            _react2.default.createElement('img', { className: 'pic', src: article.image, width: '355', height: '200', alt: article.title })
          ),
          _react2.default.createElement(
            'header',
            null,
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            'div',
            { id: 'position_one_video_columns' },
            _react2.default.createElement(
              'div',
              { id: 'position_one_video' },
              _react2.default.createElement(
                'div',
                { style: { height: '318px' } },
                mainArticle
...
},{"../actions/ArticlesActions":1,"../stores/ArticlesStore":8,"react":"react","react-router":"react-router"}],5:[function(require,module,exports){
"use strict";
...
var ArticlesStore = function () {
  function ArticlesStore() {
    ...
    this.bindActions(_ArticlesActions2.default);
    this.articles = [];
  }
...
exports.default = _alt2.default.createStore(ArticlesStore);

},{"../actions/ArticlesActions":1,"../alt":2}],9:[function(require,module,exports){
